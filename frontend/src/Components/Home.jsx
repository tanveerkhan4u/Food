          ...
          <div>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-14 sm:gap-4">
              <div className='text-center flex justify-center items-center flex-col gap-2 px-2'>
                <p className='text-dark/70 font-semibold'>Choose healthy food for better energy, improved mood, and long-term wellness. </p>
              ...
              <div className='text-center flex justify-center items-center flex-col gap-2 px-2'>
                ...
                <p className='text-dark/70 font-semibold'>
                  Food nourishes the body, fuels the mind, and brings people together. </p>
              </div>
              <div className='text-center flex justify-center items-center flex-col gap-2 px-2'>
                <p className='text-dark/70 font-semibold'>Indulge in a juicy burger at our restaurant for a satisfying and flavorful experience.</p>
              ...
              <div className='text-center flex justify-center items-center flex-col gap-2 px-2'>
                ...
                <p className='text-dark/70 font-semibold'>Experience culinary excellence and exceptional service at the best restaurant in town.
